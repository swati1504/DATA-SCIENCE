...
### The dataset of the News Classification has been retrieved from Kaggle since it is a large dataset, I have placed a link below to it

#### https://www.kaggle.com/uciml/news-aggregator-dataset
### (The dataset can be downloaded from the above page)

### The projects make use of the inbuilt libraries of python like pandas, numpy, matplotlib, scikit-learn, seaborn thereby depicting a comprehensive understanding of all the topics. 
